...
export class MeController {
  ...
  getNutritionSummary(@CurrentUser() userId: string, @Query() query: NutritionSummaryQueryDto) {
    return this.me.getNutritionSummary(userId, query.granularity ?? 'day', query.count ?? 7, query.today);
  }
}
